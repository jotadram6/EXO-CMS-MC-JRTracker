...
Req11=EXORequest('WGamma Resonance 1','Josh Kunkle','Young Do',ListOfRequests('EXO-RunIIFall17GS-01222','EXO-RunIIFall17GS-01269'), [''], False)
Req12=EXORequest('WGamma Resonance 2','Josh Kunkle','Young Do',ListOfRequests('EXO-RunIIFall17wmLHEGS-00398','EXO-RunIIFall17wmLHEGS-00445'), [''], False)
Req13=EXORequest('WGamma Resonance 3','Josh Kunkle','Young Do',ListOfRequests('EXO-RunIIFall17GS-01174','EXO-RunIIFall17GS-01221'), [''], False)
Req14=EXORequest('WGamma Resonance 4','Josh Kunkle','Young Do',ListOfRequests('EXO-RunIIFall17wmLHEGS-00350','EXO-RunIIFall17wmLHEGS-00397'), [''], False)
#######################################################################################################
...
Req24=EXORequest('LUX QED Gamma Gamma To LL','Laurent Thomas','Camilo',ListOfRequests('EXO-RunIIFall17GS-01270','EXO-RunIIFall17GS-01285'), [''], False)
Req25=EXORequest('RSGraviton To GammaGamma 1','Uzziel Perez','Camilo',ListOfRequests('EXO-RunIIFall17GS-01787','EXO-RunIIFall17GS-01815'), [''], False)
Req26=EXORequest('RSGraviton To GammaGamma 2','Uzziel Perez','Camilo',ListOfRequests('EXO-RunIIFall17GS-01816','EXO-RunIIFall17GS-01843'), [''], False)
Req27=EXORequest('ADD Graviton to GammaGamma 1','Uzziel Perez','Camilo',ListOfRequests('EXO-RunIIFall17GS-01844','EXO-RunIIFall17GS-01880'), [''], False)
Req28=EXORequest('ADD Graviton to GammaGamma 2','Uzziel Perez','Camilo',ListOfRequests('EXO-RunIIFall17GS-01881','EXO-RunIIFall17GS-01917'), [''], False)
Req29=EXORequest('ADD Graviton to GammaGamma 3','Uzziel Perez','Camilo',ListOfRequests('EXO-RunIIFall17GS-01918','EXO-RunIIFall17GS-01951'), [''], False)
#Req30=EXORequest('Semi-Invisible Higgs','','Bora',ListOfRequests('EXO-RunIIWinter15wmLHE-03125','EXO-RunIIWinter15wmLHE-03127'), [''], False)
Req31=EXORequest('Dark Photon 2016','Swagata Mukherjee','Jose',ListOfRequests('EXO-RunIISummer15wmLHEGS-06348','EXO-RunIISummer15wmLHEGS-06375'), [''], False)
Req32=EXORequest('Dark Photon 2017','Swagata Mukherjee','Jose',ListOfRequests('EXO-RunIIFall17wmLHEGS-00476','EXO-RunIIFall17wmLHEGS-00503'), [''], False)
Req33=EXORequest('Dark Photon 2018','Swagata Mukherjee','Jose',ListOfRequests('EXO-RunIIFall18wmLHEGS-00011','EXO-RunIIFall18wmLHEGS-00038'), [''], False)
Req34=EXORequest('DMSimp MonoZ 2017','Andreas Albert','Jose',ListOfRequests('EXO-RunIIFall17wmLHEGS-00549','EXO-RunIIFall17wmLHEGS-00616'), [''], False)
Req35=EXORequest('DMSimp MonoZ 2018','Andreas Albert','Jose',ListOfRequests('EXO-RunIIFall18wmLHEGS-00039','EXO-RunIIFall18wmLHEGS-00106'), [''], False)
Req36=EXORequest('Delayed jets 2016','Matthew Citron','David',ListOfRequests('EXO-RunIISummer15GS-13704','EXO-RunIISummer15GS-13787'), [''], False)
Req37=EXORequest('Delayed jets 2017','Matthew Citron','David',ListOfRequests('EXO-RunIIFall17GS-01512','EXO-RunIIFall17GS-01595'), [''], False)
Req38=EXORequest('Delayed jets 2018','Matthew Citron','David',ListOfRequests('EXO-RunIIFall18GS-00181','EXO-RunIIFall18GS-00264'), [''], False)
Req39=EXORequest('RPV neutralino 2016','Matthew Citron','David',ListOfRequests('EXO-RunIISummer15GS-13789','EXO-RunIISummer15GS-13824'), [''], False)
Req40=EXORequest('RPV neutralino 2017','Matthew Citron','David',ListOfRequests('EXO-RunIIFall17GS-01596','EXO-RunIIFall17GS-01631'), [''], False)
Req41=EXORequest('RPV neutralino 2018','Matthew Citron','David',ListOfRequests('EXO-RunIIFall18GS-00265','EXO-RunIIFall18GS-00300'), [''], False)
Req42=EXORequest('Heavy Higgs to Diphoton','','Camilo',ListOfRequests('EXO-RunIIFall17GS-01634','EXO-RunIIFall17GS-01677'), [''], False)
Req43=EXORequest('Unpart Z To EE And MuMu 2017','Andreas Albert','Camilo',ListOfRequests('EXO-RunIIFall17GS-02412','EXO-RunIIFall17GS-02427'), [''], False)
Req44=EXORequest('Unpart Z To EE And MuMu 2018','Andreas Albert','Camilo',ListOfRequests('EXO-RunIIFall18GS-00322','EXO-RunIIFall18GS-00337'), [''], False)
Req45=EXORequest('Displaced Vertices 2017','Jordan Tucker','Bora',ListOfRequests('EXO-RunIIFall17GS-02237','EXO-RunIIFall17GS-02326'), [''], False)
Req46=EXORequest('GluGlu to ZH 2017','Kyungwook Nam','Camilo',ListOfRequests('EXO-RunIIFall17GS-01634','EXO-RunIIFall17GS-01677'), [''], False)
Req47=EXORequest('tt+scalar 2016','Maxi Heindl','David',ListOfRequests('EXO-RunIISummer15wmLHEGS-06421','EXO-RunIISummer15wmLHEGS-06546'), [''], False)
Req48=EXORequest('tt+scalar 2017','Maxi Heindl','David',ListOfRequests('EXO-RunIIFall17wmLHEGS-00990','EXO-RunIIFall17wmLHEGS-01115'), [''], False)
Req49=EXORequest('tt+scalar 2018','Maxi Heindl','David',ListOfRequests('EXO-RunIIFall18wmLHEGS-00357','EXO-RunIIFall18wmLHEGS-00482'), [''], False)
Req50=EXORequest('Seesaw 2016','Maxi Heindl','David',ListOfRequests('EXO-RunIISummer15wmLHEGS-06547','EXO-RunIISummer15wmLHEGS-06606'), [''], False)
Req51=EXORequest('Seesaw 2017','Maxi Heindl','David',ListOfRequests('EXO-RunIIFall17wmLHEGS-00930','EXO-RunIIFall17wmLHEGS-00989'), [''], False)
Req52=EXORequest('Seesaw 2018','Maxi Heindl','David',ListOfRequests('EXO-RunIIFall18wmLHEGS-00297','EXO-RunIIFall18wmLHEGS-00356'), [''], False)
Req53=EXORequest('Drell-Yan pT-binned','General','Jose',ListOfRequests('EXO-RunIIFall18wmLHEGS-00483','EXO-RunIIFall18wmLHEGS-00490'), [''], False)
Req54=EXORequest('PSeudoscalar2HDM MonoZLL 2016','Andreas Albert','Shubhanshu',ListOfRequests('EXO-RunIISummer15wmLHEGS-06376','EXO-RunIISummer15wmLHEGS-06420'), [''], False)
Req55=EXORequest('PSeudoscalar2HDM MonoZLL 2017','Andreas Albert','Shubhanshu',ListOfRequests('EXO-RunIIFall17wmLHEGS-00504','EXO-RunIIFall17wmLHEGS-00548'), [''], False)
Req56=EXORequest('PSeudoscalar2HDM MonoZLL 2018','Andreas Albert','Shubhanshu',ListOfRequests('EXO-RunIIFall18wmLHEGS-00107','EXO-RunIIFall18wmLHEGS-00151'), [''], False)
Req57=EXORequest('MonoZ ADD 2017','Andreas Albert','Jane',ListOfRequests('EXO-RunIIFall17GS-02428','EXO-RunIIFall17GS-02448'), [''], False)
Req58=EXORequest('MonoZ ADD 2018','Andreas Albert','Jane',ListOfRequests('EXO-RunIIFall18GS-00374','EXO-RunIIFall18GS-00394'), [''], False)
#Req5=EXORequest('','','',ListOfRequests('',''), [''], False)
